...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([
        [ InlineKeyboardButton("Our Official Channel 🥳", url="https://t.me/rumair3")],
        [ InlineKeyboardButton("If You Need Help 👈", url="https://replit.com/@bipinkrish/Link-Bypasser#app.py") ]]), 
